...
Partial Class GestionProductos
    ...
    Private Sub InitializeComponent()
        ...
        dgvProductos.Location = New Point(18, 161)
        ...
        btnAgregar.Location = New Point(465, 36)
        ...
        btnEliminar.Location = New Point(671, 36)
        ...
        btnEditar.Location = New Point(568, 36)
        ...
        Panel3.Controls.Add(BuscarProducto)
        ...
        Panel3.Name = "Panel3"
        Panel3.Size = New Size(802, 85)
        Panel3.TabIndex = 8
        ' 
        ' BuscarProducto
        ' 
        BuscarProducto.AutoSize = True
        BuscarProducto.Font = New Font("Yu Gothic", 9F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        BuscarProducto.Location = New Point(18, 22)
        BuscarProducto.Name = "BuscarProducto"
        BuscarProducto.Size = New Size(98, 16)
        BuscarProducto.TabIndex = 5
        BuscarProducto.Text = "Buscar Producto"
        ' 
        ' txtBuscar
        ' 
        txtBuscar.Location = New Point(18, 41)
    ...
    Friend WithEvents BuscarProducto As Label
